...
public class TestGenerico {
    ...
    public static void main(String args[]){
        ...
        System.out.println("Busco ancestros de raiz deberia dar vacio: " + a.ancestros(10).toString());
        System.out.println("Busco ancestros de 3 deberia dar 9 - 10 : " + a.ancestros(3).toString());
        System.out.println("Busco ancestros de 40 deberia dar  30 - 15 - 10  : " + a.ancestros(40).toString());
        System.out.println("Busco ancestros de elemento inexistente deberia dar vacio: " + a.ancestros(3333).toString());
